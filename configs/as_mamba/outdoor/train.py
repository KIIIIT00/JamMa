...
cfg.AS_MAMBA.FINE_WINDOW_SIZE = 3
cfg.AS_MAMBA.COARSE.D_MODEL = 128
cfg.AS_MAMBA.FINE.D_MODEL = 64
cfg.AS_MAMBA.N_BLOCKS = 1
cfg.AS_MAMBA.GLOBAL_DEPTH = 1
cfg.AS_MAMBA.LOCAL_DEPTH = 1
...
cfg.AS_MAMBA.LOSS.GEOM_WEIGHT = 0.1